...
//
//  Copied from
//    https://github.com/leptos-null/PrayerTimes/blob/91f35b1/PrayerTimesKit/UserDefaults%2BTyped.swift
//
...
extension UserDefaults {
    static let logger = Logger(subsystem: "null.leptos.WorkoutSpot", category: "UserDefaults")
